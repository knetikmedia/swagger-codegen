...
public class ObjcModelTest {
	...
	public void simpleModelTest() {
		final Model model = new ModelImpl().description("a sample model").property("id", new LongProperty())
				.property("name", new StringProperty()).property("createdAt", new DateTimeProperty()).required("id")
	...
	public void mapModelTest() {
		final Model model = new ModelImpl().description("a map model")
	...
	public void udidAndPasswordDataModelTest() {
		final Swagger model = new SwaggerParser()
